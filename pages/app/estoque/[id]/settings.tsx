...
export default function EstoqueSettings() {
    const router = useRouter();

    // TODO: Undefined check redirects to error
    const { id: estoqueId } = router.query;

    const { data: settings, isValidating } = useSWR<WithSiteEstoque>(
    ...
    async function saveEstoqueSettings(data: SettingsData) {
        setSaving(true);
    ...
    async function deleteEstoque(estoqueId: string) {
        ...
        try {
            const response = await fetch(`/api/estoque?estoqueId=${estoqueId}`, {
        ...
        <>
            <Layout siteId={settings?.site?.id}>
                ...
                <div className="max-w-screen-xl mx-auto px-10 sm:px-20 mt-20 mb-16">
                    <h1 className="font-cal text-5xl mb-12">Estoque Settings</h1>
                    <div className="mb-28 flex flex-col space-y-12">
                        <div className="space-y-6">
                            <h2 className="font-cal text-2xl">Estoque Slug</h2>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex flex-col space-y-6 max-w-lg">
                                <h2 className="font-cal text-2xl">Delete estoque</h2>
                                <p>
                                    Permanently delete your estoque and all of its contents from our
                ...
                <Modal showModal={showDeleteModal} setShowModal={setShowDeleteModal}>
                    ...
                    >
                        ...
                        <div className="flex justify-between items-center mt-10 w-full">
                            ...
                            >
                                {deletingEstoque ? <LoadingDots /> : "DELETE Estoque"}
                            </button>
                        </div>
                    </form>
                </Modal>
